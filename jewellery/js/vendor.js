...
!function() {
  ...
  var t = {
    d: function(n, e) {
      for (var i in e) t.o(e, i) && !t.o(n, i) &&
  ...
  var T = 'slide', A = 'loop', O = 'fade', L = function(t, n) {
    ...
    return {
      mount: function() {
        ...
        i = u, t.is(T) && (0 === s && r >= d || s >= d && 0 === r) &&
        (f = c.rewindSpeed || f), E(e, {
  ...
  var U = function() {
    function t(t, e, i) {
      var o;
      void 0 === e && (e = {}), void 0 === i &&
      (i = {}), this.root = t instanceof Element ?
        t :
        document.querySelector(t), j(this.root,
        'An invalid element/selector was given.'), this.Components = null, this.Event = function() {
        var t = [];
        ...
        return {
          on: function(n, e, i, o) {
            void 0 === i && (i = null), void 0 === o && (o = {}), n.split(' ').
              forEach((function(n) {
                i && i.addEventListener(n, e, o), t.push(
                  {event: n, handler: e, elm: i, options: o});
              }));
          }, off: function(e, i) {
            ...
            for (var e = arguments.length, i = new Array(
              e > 1 ? e - 1 : 0), o = 1; o < e; o++) i[o - 1] = arguments[o];
      ...
      }), this.STATES = n, this._o = a(N,
        e), this._i = 0, this._c = i, this._e = {}, this._t = null;
    }

    var e, i, s, u = t.prototype;
    return u.mount = function(t, n) {
      var e = this;
      void 0 === t && (t = this._e), void 0 === n &&
      (n = this._t), this.State.set(
        R), this._e = t, this._t = n, this.Components = function(t, n, e) {
        var i = {};
      ...
      return i.set(B), o(this.Components, (function(t) {
        ...
        {visibility: 'visible'}), this.on('move drag', (function() {
        return i.set(G);
      ...
      return void 0 === e && (e = null), void 0 === i &&
      (i = {}), this.Event.on(t, n, e, i), this;
    }, u.off = function(t, n) {
      return void 0 === n && (n = null), this.Event.off(t, n), this;
    }, u.emit = function(t) {
      for (var n, e = arguments.length, i = new Array(
        e > 1 ? e - 1 : 0), o = 1; o < e; o++) i[o - 1] = arguments[o];
      return (n = this.Event).emit.apply(n, [t].concat(i)), this;
    }, u.go = function(t, n) {
      return void 0 === n &&
      (n = this.options.waitForTransition), (this.State.is(F) ||
        this.State.is(G) && !n) && this.Components.Controller.go(t, !1), this;
    }, u.is = function(t) {
      return t === this._o.type;
    }, u.add = function(t, n) {
      return void 0 === n && (n = -1), this.Components.Elements.add(t, n,
      ...
      var n = this;
      if (void 0 === t && (t = !0), !this.State.is(R)) return r(
        this.Components).reverse().forEach((function(n) {
        n.destroy && n.destroy(t);
      })), this.emit('destroy', t), this.Event.destroy(), this.State.set(
        X), this;
    ...
    }, e = t, (i = [
      {
        ...
        key: 'options', get: function() {
          ...
          n || this.emit('update'), this._o = a(this._o, t), n ||
    ...
    var u = {
      mount: function() {
        ...
        var t = this;
        !function() {
          u.slider = g(e, i.slider), u.track = p(e, '.' + i.track), u.list = g(
            u.track, i.list), j(u.track && u.list,
            'Track or list was not found.'), u.slides = v(u.list, i.slide);
          var t = d(i.arrows);
          u.arrows = {prev: p(t, '.' + i.prev), next: p(t, '.' + i.next)};
          var n = d(i.autoplay);
          u.bar = p(d(i.progress), '.' + i.bar), u.play = p(n,
            '.' + i.play), u.pause = p(n,
            '.' + i.pause), u.track.id = u.track.id || e.id +
            '-track', u.list.id = u.list.id || e.id + '-list';
        ...
        var o = function(t, n, e, i) {
          var o = t.options.updateOnMove,
            s = 'ready.slide updated.slide resized.slide moved.slide' +
              (o ? ' move.slide' : ''), a = {
              slide: i,
              index: n,
              realIndex: e,
              ...
              mount: function() {
                var r = this;
                this.isClone || (i.id = t.root.id + '-slide' + l(n + 1)), t.on(s,
                  (function() {
                    return r.update();
              ...
              destroy: function() {
                t.off(s).off(Q).off('click', i), S(i, r(D)), c(), I(
              ...
              isWithin: function(e, i) {
                var o = Math.abs(e - n);
                return t.is(T) || this.isClone ||
                (o = Math.min(o, t.length - o)), o < i;
              },
            };
        ...
        var i = n.Controller.toIndex(e), o = t.options,
        ...
        if ('string' == typeof t && (t = y(t)), t instanceof Element) {
          ...
          E(t, {display: 'none'}), i ?
            ...
            (w(this.list, t), this.slides.push(t)), function(t, n) {
    ...
    var e, i, o = {
      mount: function() {
        ...
        var i = t.index, r = String(n).match(/([+\-<>]+)(\d+)?/),
          s = r ? r[1] : '', a = r ? parseInt(r[2]) : 0;
        switch (s) {
          case'+':
            i += a || 1;
            break;
        ...
        return i - o <= (s -= (this.pageLength * o - i) * $(s / i)) && s < i &&
        (s = i - o), s;
      }, toPage: function(n) {
        if (r()) return n;
        ...
        var n = t.index + 1;
        return (i || e.rewind) && (n = this.rewind(n)), t.index < n && n <=
        this.edgeIndex || 0 === n ? n : -1;
      },
    };
    ...
    var e, i, o, r = t.options.direction === K, s = t.is(O),
      a = t.options.direction === J, u = !1, d = a ? 1 : -1, f = {
        sign: d, mount: function() {
          ...
          var r = h(e), a = t.index;
          t.State.is(G) && u ||
          (u = e !== i, o || t.emit('move', i, a, e), Math.abs(
            r - this.position) >= 1 || s ?
          ...
          var n = nt(this.position), e = nt(this.toPosition(0)),
            i = nt(this.toPosition(t.length)), o = i - e;
    ...
    function l(n, e, i, r) {
      E(o, {transition: ''}), u = !1, s || f.jump(e), r ||
      t.emit('moved', e, i, n);
    }
    ...
    function a() {
      ...
      return r && (e = Math.ceil(o.track['client' + i] / r)), e *
      (n.drag ? n.flickMaxPages + 1 : 1);
    }
  ...
  var rt = function(t, n) {
      var e, o, r = n.Elements, s = t.options.direction === K, a = (e = {
        mount: function() {
          t.on('resize load', ot((function() {
            t.emit('resize');
          }), t.options.throttle), window).
            on('resize', c).
            on('updated refresh', u), u(), this.totalSize = s ?
            this.totalHeight :
            this.totalWidth, this.slideSize = s ?
            this.slideHeight :
            this.slideWidth;
        }, destroy: function() {
        ...
        return {
          margin: 'marginBottom', init: function() {
            ...
            this.padding = {top: s, bottom: a}, E(e,
              {paddingTop: f(s), paddingBottom: f(a)});
            ...
            var e = i.fixedHeight || (this.height + this.gap) / i.perPage -
              this.gap;
            return h(r, e);
          }, get width() {
            ...
            return j(t, '"height" or "heightRatio" is missing.'), h(r, t) -
        ...
        return {
          ...
          resize: function() {
            ...
            this.padding = {left: s, right: a}, E(e,
              {paddingLeft: f(s), paddingRight: f(a)});
          },
      ...
      var e, i, r, s, a = n.Track, u = n.Controller,
        d = t.options.direction === K, f = d ? 'y' : 'x', l = {
      ...
      function v() {
        i = null, s && (t.emit('dragged', r), function(e) {
          ...
          if (o > 0) {
            ...
            if (!t.is(O)) {
              var h = a.position;
              o > r.flickVelocityThreshold && st(e.offset[f]) <
              r.swipeDistanceThreshold && (h += d * Math.min(o * r.flickPower,
                n.Layout.size * (r.flickMaxPages || 1))), l = a.toIndex(h);
            }
            l === s && o > .1 && (l = s + d * a.sign), t.is(T) &&
            (l = c(l, 0, u.edgeIndex)), u.go(l, r.isNavigation);
          }
        }(r), s = !1);
      }

      function m(t, n) {
        var e = t.timeStamp, i = t.touches, o = i ? i[0] : t, r = o.clientX,
          s = o.clientY, a = n.to || {}, u = a.x, c = void 0 === u ? r : u,
          d = a.y, f = {x: r - c, y: s - (void 0 === d ? s : d)},
          l = e - (n.time || 0);
        return {
          to: {x: r, y: s},
          offset: f,
      ...
      function c() {
        ...
        i.disabled = s < 0 || !u, o.disabled = a < 0 || !u, t.emit(e + ':updated',
          i, o, s, a);
      }

      function d(n) {
        return y('<button class="' + s.arrow + ' ' + (n ? s.prev : s.next) +
      ...
      return {
        required: t.options.arrows, mount: function() {
          i = u.arrows.prev, o = u.arrows.next, i && o || !t.options.arrows ||
          (i = d(!0), o = d(!1), r = !0, function() {
    ...
    }, ht = 'move.page', pt = 'updated.page refresh.page',
    gt = function(t, n, e) {
      ...
      function s(n, o) {
        ...
        s && S(s.button, u), a && k(a.button, u), t.emit(e + ':updated', i, s,
          a);
      }

      return r;
    }, vt = 'data-splide-lazy', mt = 'data-splide-lazy-srcset',
    yt = 'aria-current', bt = 'aria-controls', wt = 'aria-label',
    xt = 'aria-hidden', Et = 'tabindex', _t = {
      ...
      function u(n, i) {
        i && C(i.button, yt, !0), n.items.forEach((function(n) {
          var i = t.options,
            o = d(!1 === i.focus && i.perPage > 1 ? e.pageX : e.slideX,
              n.page + 1), r = n.button, s = n.Slides.map((function(t) {
              return t.slide.id;
            }));
      ...
      function f(t) {
        i.each((function(n) {
          ...
          h(i) || C(i, 'role', 'button');
          var r = o > -1 ? o : n.index, s = d(e.slideX, r + 1),
      ...
      return {
        required: t.options.accessibility, mount: function() {
          ...
          t.on('navigation:mounted navigation:updated', f).
            ...
            var n = i[t];
            n &&
            (h(n) || C(n, 'role', 'button'), C(n, bt, i.track.id), C(n, wt, e[t]));
          }));
        }, destroy: function() {
    ...
    }, St = 'move.sync', Pt = 'mouseup touchend', Ct = [' ', 'Enter', 'Spacebar'],
    zt = {
      Options: Y,
      Breakpoints: function(t) {
        ...
        return {
          required: i && matchMedia, mount: function() {
            ...
            })), this.destroy(!0), addEventListener('resize',
              o), n = t.options, s();
          }, destroy: function(t) {
        ...
        var i, o = [], r = n.Elements, s = {
          required: t.options.autoplay, mount: function() {
            ...
            r.slides.length > n.perPage && (i = function(t, n, e) {
              var i, o, r, s = window.requestAnimationFrame, a = !0,
                u = function u(c) {
                  a ||
                  (i || (i = c, r && r < 1 && (i -= r * n)), r = (o = c - i) /
                    n, o >= n && (i = 0, r = 1, t()), e && e(r), s(u));
                };
              return {
                pause: function() {
                  a = !0, i = 0;
            ...
            void 0 === n && (n = 0), i.pause(), -1 === o.indexOf(n) &&
            o.push(n), 1 === o.length && t.emit(e + ':pause');
          },
        };
      ...
      LazyLoad: function(t, n, e) {
        ...
        function c(n) {
          n = isNaN(n) ? t.index : n, (r = r.filter((function(t) {
            return !t.Slide.isWithin(n, s.perPage * (s.preloadPages + 1)) ||
              (d(t.img, t.Slide), !1);
          })))[0] || t.off('moved.' + e);
        }
        ...
        function l(n, i, o, r) {
          S(o.slide, D.loading), r ||
          (b(i), E(n, {display: ''}), t.emit(e + ':loaded', n).
            emit('resize')), a && f();
        }
          ...
          required: s.lazyLoad, mount: function() {
            t.on('mounted refresh', (function() {
              u(), n.Elements.each((function(t) {
                o(t.slide.querySelectorAll('[data-splide-lazy], [' + mt + ']'),
                  (function(n) {
                    n.src || n.srcset ||
        ...
        return {
          mount: function() {
            t.on('mounted updated', (function() {
              var e = t.options, i = t.root, o = _t[e.direction],
                r = e.keyboard;
              n && (t.off('keydown', n), I(i, Et)), r &&
              ('focused' === r ? (n = i, C(i, Et, 0)) : n = document, t.on(
                'keydown', (function(n) {
  ...
  var It = function(t) {
    ...
    return e = t, (n = i).prototype = Object.create(
      e.prototype), n.prototype.constructor = n, n.__proto__ = e, i;
  }(U);
  window.Splide = It;
}();
